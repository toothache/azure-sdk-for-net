...
namespace Microsoft.Azure.CognitiveServices.Vision.ComputerVision.Models
{
    ...
    /// <summary>
    /// Defines headers for ReadDocument operation.
    /// </summary>
    public partial class ReadDocumentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ReadDocumentHeaders class.
        /// </summary>
        public ReadDocumentHeaders()
        {
            CustomInit();
        }
        ...
        public ReadDocumentHeaders(string operationLocation = default(string))
        {
